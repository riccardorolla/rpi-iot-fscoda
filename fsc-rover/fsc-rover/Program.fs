...
let initFacts () =
 ...
 tell <| Fsc.Facts.action("never",true,"led on 0")
 tell <| Fsc.Facts.action("never",false,"led off 0")
 tell <| Fsc.Facts.synopsis("photo","get photo")
 tell <| Fsc.Facts.synopsis("video","get video")  
 tell <| Fsc.Facts.synopsis("distance","get distance")
 tell <| Fsc.Facts.synopsis("left","go left")
 tell <| Fsc.Facts.synopsis("lon","led on 0")
 tell <| Fsc.Facts.synopsis("loff","led off 0")
 tell <| Fsc.Facts.synopsis("forward","go forward")
 tell <| Fsc.Facts.synopsis("backward","go backward")
 tell <| Fsc.Facts.synopsis("right","go right")
 tell <| Fsc.Facts.synopsis("stop","stop")
